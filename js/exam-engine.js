...
export const EXAM_CONFIG = {
  ...
  description:
    '재고자산(ACC_INV_*) 문항만 출제합니다. 시간 제한·랜덤 출제·Pattern별 성취도 분석으로 학습 효과를 검증합니다. (MVP 풀: ACC_INV 28문항)',
  presets: [
    {
      id: 'full',
      label: '전체 모의',
